//https://ncovi.huynhhieu.com/api.php?code=external-vn
//https://ncovi.huynhhieu.com/api.php?code=external
    ...
    if (error is DioError) {
      switch (error.type) {
        ...
        case DioErrorType.DEFAULT:
          responseError = "Connection to API server failed due to internet connection";
          break;
        ...
        case DioErrorType.RESPONSE:
          responseError =  "Received invalid status code: ${error.response.statusCode}";
          break;
      }
    } else {
